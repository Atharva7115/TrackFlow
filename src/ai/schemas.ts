...
/**
 * Zod schema for structured follow-up email draft generated by Strands Agent via Bedrock.
 */
export const FollowUpDraftSchema = z.object({
  subject: z
    .string()
    .describe('A professional, concise subject line for the follow-up email.'),
  body: z
    .string()
    .describe('A polite, professional, and candidate-appropriate follow-up email body.'),
  reasoning: z
    .string()
    .describe('A brief explanation of the tone, key context, and strategy used in the draft.'),
});
